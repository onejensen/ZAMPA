...
const PUBLISH_REASON_LABELS = {
  ...
  social_requires_review: "una fuente social pasaba siempre por revisión (regla anterior al 17/09)",
  manual_review_required: "la fuente pide revisión humana",
  external_offer_already_published: "ya se publicó hoy un menú detectado de este restaurante",
  business_has_owner: "el comercio tiene dueño y la fuente no dice «Publicar por el comercio»",
  missing_publication_date: "falta la fecha del post",
  declared_menu_needs_review: "el post no dice que sea el menú del día (en una red, «declarado» no basta)",
